...
public class Message : ISerializable
{
    ...
    public string Recipient { get; set; } // either user account email or group name
    ...
    public Message(string id, string sender, string recipient, string title, string body,
